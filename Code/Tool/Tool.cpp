...
{
    Delete * del = new Delete(glm::vec3(-0.928f , -0.75f , 0.0f) , glm::vec3(0.2f , 0.2f , 0.0f) , "delete.png" , camera);
    DataStructure * dataStructure = new DataStructure(glm::vec3(-0.918f , -0.45f , 0.0f) , glm::vec3(0.2f , 0.2f , 0.0f) , "data.png" , camera);
   
    Search * search = new Search(glm::vec3(-0.918f , -0.15f , 0.0f) , glm::vec3(0.2f , 0.2f , 0.0f) , "search.png" , camera);
    UpdateTool* updateTool = new UpdateTool(glm::vec3(-0.93f , 0.2f , 0.0f) , glm::vec3(0.4f , 0.4f , 0.0f) , "update.png" , camera); 
    NewTool * newTool = new NewTool(glm::vec3(-0.928f , 0.5f , 0.0f) , glm::vec3(0.25f , 0.25f , 0.0f) , "new.png" , camera);
