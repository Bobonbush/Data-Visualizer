...
class TextHandler {
    ...
    void RenderTextInRangeX(Shader* s, std::string text, float x, float y, float scale, glm::vec3 color , Camera * camera, float offsetX,float offsetY, float rangeX , float rangeY);
};
